...
|---|---|---|
| AGM Minutes 2022–2025 | Decisions, disputes, works, tone | ☐ |
| AGM Notice packages 2022–2025 | Budgets, levy resolutions | ☐ |
| Chairpersons Reports (2021-22, 2023-24) | Narrative on building health | ☐ |
| EGM Minutes & Notice packages | Special levies / major decisions | ☐ |
| **Financial Accounts 2022–2025** | **Levy level/trend, reserves, arrears** | ☐ |
| **Long-Term Maintenance Plan** | **Funding adequacy, upcoming capex** | ☐ |
| **Insurance Policy** | **Full replacement + EQ cover, sum insured** | ☐ |
| Management Contract | BC manager, cost | ☐ |
| Building Rules (Parts 1 & 2) | Use restrictions (e.g. short-stay letting) | ☐ |
| BCC Meeting Minutes 2015–2025 | Long-run defect/remediation history | ☐ |

## General information
| Document | Status |
|---|---|
| Complaints & Disputes Resolution Procedure.pdf | ☐ |
| Disclaimer.pdf | ☐ |
| OIO Flyers (Buying & Investing) | ☐ (N/A if NZ buyer — Citadel Capital Ltd is NZ) |
| REA S&P Guide | ☐ |

## Independent / external (order separately)
| Item | Status |
|---|---|
| Builder's / weathertightness report | ☐ |
| Engineering DEE / seismic report behind "100% NBS" claim | ☐ |
| Christchurch CC rates confirmation | ☐ |
| Insurance confirmation in writing (broker) | ☐ |
| Agent: live status + price history + other-unit sold prices | ☐ |
